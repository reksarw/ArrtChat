...
<li class="active"><a href="?arrt=room&r=v&id=<?php echo $_GET['id'] ?>">Detail user</a></li>
...
<!-- PAGE CONTENT WRAPPER -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          ...
                          <form class="form-horizontal" action="" method="post" role="form" enctype="multipart/form-data" >
                               <input type="hidden" name="arrt" value="room" />
							<input type="hidden" name="r" value="edit" />
							<input type="hidden" name="id" value="<?php echo $record[room_id]?>" />
                            <div class="panel panel-default">	
                                ...
                                <div class="panel-body">                                                                        
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="proom" value="<?php echo $record[user_create]?>" required />
                                            </div>                                            
									  ...
									  <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="nameroom" value="<?php echo $record[room_name]?>" required />
                                            </div>                                            
                                    ...
                                    <div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">Room Password</label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" id="repeatPass" name="rpass1" required />
                                            </div>            
	...
	<?php
						...
						echo"
						<img src='../../images/$gambar' width='120px' height='90px' />
