...
<li class="active"><a href="?arrt=user&u=v&id=<?php echo $_GET[id]?>">Detail user</a></li>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="nickname" value="<?php echo $record[nickname]?>" required />
                                            </div>                                            
